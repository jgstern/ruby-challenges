def find_birth_path_number(birthdate)
	...
	number_stringified = number.to_s

	number = number_stringified[0].to_i + number_stringified[1].to_i
...
print "Please enter your birthdate in the format MMDDYYYY: "
birthdate=gets

birth_path_number = find_birth_path_number(birthdate)
